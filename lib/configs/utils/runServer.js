...
var _prepareBuildTools2 = require('../../configs/prepare.build-tools.config');

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

let server;
let pending = true;
const serverPath = _path2.default.join(_prepareBuildTools.outputServer, _prepareBuildTools.entryServer);
	...
	if (_prepareBuildTools.isIsomorphic) {
		...
		return new Promise(resolve => {
			function onStdOut(data) {
				...
				const wasRun = data.toString('utf8').indexOf(_prepareBuildTools2.serverWasRunDetectString) !== -1;
