...
const spa = (0, _generalWebpack2.default)({
	...
	rules: [(0, _babel2.default)(/\.(jsx|js)?$/, [], ['inferno'], _prepareBuildTools.babelEnvSpa, [/node_modules/, /mobx.js/]), (0, _css.internalCSS)(), (0, _css.externalCSS)(), (0, _files.file)()],
...
const server = (0, _generalWebpack2.default)({
	...
	(0, _babel2.default)(/\.(js|jsx)?$/, [], ['inferno'], _prepareBuildTools.babelEnvServer), (0, _css.internalCSS)(), (0, _css.externalCSS)(), (0, _files.file)()],
	plugins: [
