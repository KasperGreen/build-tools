...
const spa = (0, _generalWebpack2.default)({
	...
	rules: [(0, _babel2.default)(/\.(jsx|js)?$/, reactBabelPresets, reactBabelPlugin, _prepareBuildTools.babelEnvSpa, [/node_modules/, /mobx.js/]), (0, _css.internalCSS)(), (0, _css.externalCSS)(), (0, _files.file)()],
	plugins: [(0, _js.extractVendors)(), ...(0, _css2.extractCSS)(), ...(0, _js.HMR)(), ...(0, _js.uglify)(), ...(0, _js.getAssetsFile)(), ...(0, _js.getIndexHtmlFile)()]
});
...
const server = (0, _generalWebpack2.default)({
	...
	(0, _babel2.default)(/\.(js|jsx)?$/, reactBabelPresets, reactBabelPlugin, _prepareBuildTools.babelEnvServer), (0, _css.internalCSS)(), (0, _css.externalCSS)(), (0, _files.file)()],
	plugins: [
